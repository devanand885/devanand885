#!/usr/bin/env python3
"""
GitHub Profile Stats Card SVG Generator for devanand885
...
DEFAULT_USERNAME = os.environ.get("GITHUB_REPOSITORY_OWNER", "devanand885")
...
DEMO_STATS = {
    ...
    "total_commits": 410,
    "languages": [
        {"name": "Python", "color": "#3572A5", "percent": 45.0},
        {"name": "Java", "color": "#b07219", "percent": 25.0},
        {"name": "JavaScript", "color": "#f1e05a", "percent": 15.0},
        {"name": "HTML", "color": "#e34c26", "percent": 10.0},
        {"name": "CSS", "color": "#563d7c", "percent": 5.0},
    ]
}
